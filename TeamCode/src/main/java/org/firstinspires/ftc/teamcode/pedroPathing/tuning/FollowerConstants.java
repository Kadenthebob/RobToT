...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "leftFo2";
    public static String leftRearMotorName = "leftB";
    public static String rightFrontMotorName = "rightFo1";
    public static String rightRearMotorName = "rightBo3";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    //53.9907 at around 12 volts


    public static double xMaxMovement = 59; //taken at 13.9 volts
    public static double yMaxMovement = 44.7; //taken at 13.45 volts


    public static double xMovement = 59;
    public static double yMovement = 44.7;

    public static double xVolts = 13.9;
    public static double yVolts = 13.45;
    ...
    public static double mass = 14.56;
    ...
    public static double forwardZeroPowerAcceleration = -55.7428;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -56.5;
