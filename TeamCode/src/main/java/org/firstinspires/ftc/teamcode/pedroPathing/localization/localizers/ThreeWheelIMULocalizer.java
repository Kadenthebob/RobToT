...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(11.024/2-4.07, 12.000/2, 0);
        rightEncoderPose = new Pose(11.024/2-4.07, -12.000/2, 0);
        strafeEncoderPose = new Pose(-5.75, 15.3125/2-7.375, Math.toRadians(90));

        // TODO: replace these with your encoder ports
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "leftFo2"));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightFo1"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightBo3"));
